...
function me(r, t) {
  ...
  for (let m = 0; m < r.length; m++) {
    ...
    if (!(w2 === ze && (d2 = r.charCodeAt(m + 1), d2 === ie2))) if (w2 === Ve) u2 === "" && (g2 = m), u2 += r.slice(m, m + 2), m += 1;
      ...
      for (let x = m + 1; x < r.length; x++) if (d2 = r.charCodeAt(x), d2 === Ve) x += 1;
        ...
        if (d2 === Le && (r.charCodeAt(x + 1) === ie2 || r.charCodeAt(x + 1) === ze && r.charCodeAt(x + 2) === ie2)) throw new Error(`Unterminated string: ${r.slice(v2, x + 1) + String.fromCharCode(w2)}`);
        if (d2 === ie2 || d2 === ze && r.charCodeAt(x + 1) === ie2) throw new Error(`Unterminated string: ${r.slice(v2, x) + String.fromCharCode(w2)}`);
      }
      u2 += r.slice(v2, m + 1);
    } else {
      if ((w2 === Ne || w2 === ie2 || w2 === Me) && (d2 = r.charCodeAt(m + 1)) && (d2 === Ne || d2 === ie2 || d2 === Me || d2 === ze && (d2 = r.charCodeAt(m + 2)) && d2 == ie2)) continue;
      if (w2 === ie2) {
        if (u2.length === 0) continue;
        d2 = u2.charCodeAt(u2.length - 1), d2 !== Ne && d2 !== ie2 && d2 !== Me && (u2 += " ");
...
function H2(r, t = []) {
  return r.charCodeAt(0) === di ? Se(r, t) : M2(r, t);
}
...
function ve(r, t, i = 3) {
  let e = [], n = /* @__PURE__ */ new Set(), s2 = new B2(() => /* @__PURE__ */ new Set()), a = new B2(() => /* @__PURE__ */ new Set()), c = /* @__PURE__ */ new Set(), u2 = /* @__PURE__ */ new Set(), f2 = [], g2 = [], d2 = new B2(() => /* @__PURE__ */ new Set());
  ...
  if (w2 = w2.concat(e), i & 2) for (let [v2, x] of a) for (let k2 of x) {
    ...
    let b2 = q2(k2.value), S = false;
    if (ee2(b2, (R2, { replaceWith: _2 }) => {
      if (R2.kind !== "function" || R2.value !== "color-mix") return;
      let K2 = false, G2 = false;
      if (ee2(R2.nodes, (I2, { replaceWith: W2 }) => {
    ...
    let P2 = { ...k2, value: Y2(b2) }, U2 = H2("@supports (color: color-mix(in lab, red, red))", [k2]);
...
function* Xt(r, t) {
  ...
  } else g2 = tr(a, (d2) => t.utilities.has(d2, "functional"));
  for (let [d2, m] of g2) {
...
var yt = class {
  constructor() {
    __publicField(this, "utilities", new B2(() => []));
...
function X2(r, t, i) {
  ...
  return e ? Q2(r, e) : de(t.value) ? Q2(r, `${t.value}%`) : null;
}
function te2(r, t, i) {
  let e = null;
...
function sr(r) {
  ...
  function e(o, p2) {
    t.static(o, () => p2.map((h2) => typeof h2 == "function" ? h2() : l3(h2[0], h2[1])));
  }
  function n(o, p2) {
    function h2({ negative: A2 }) {
      return (y2) => {
        ...
        if (y2.value) if (y2.value.kind === "arbitrary") {
          ...
          if (C2 = r.resolve(y2.value.fraction ?? y2.value.value, p2.themeKeys ?? []), C2 === null && p2.supportsFractions && y2.value.fraction) {
            let [V2, T2] = g(y2.value.fraction, "/");
            if (!p(V2) || !p(T2)) return;
            C2 = `calc(${y2.value.fraction} * 100%)`;
          }
          if (C2 === null && A2 && p2.handleNegativeBareValue) {
            if (C2 = p2.handleNegativeBareValue(y2.value), !(C2 == null ? void 0 : C2.includes("/")) && y2.modifier) return;
            if (C2 !== null) return p2.handle(C2, null);
          }
          if (C2 === null && p2.handleBareValue && (C2 = p2.handleBareValue(y2.value), !(C2 == null ? void 0 : C2.includes("/")) && y2.modifier)) return;
        }
        else {
          if (y2.modifier) return;
          C2 = p2.defaultValue !== void 0 ? p2.defaultValue : r.resolve(null, p2.themeKeys ?? []);
        }
        if (C2 !== null) return p2.handle(A2 ? `calc(${C2} * -1)` : C2, O2);
      };
    }
    p2.supportsNegative && t.functional(`-${o}`, h2({ negative: true })), t.functional(o, h2({ negative: false })), i(o, () => [{ supportsNegative: p2.supportsNegative, valueThemeKeys: p2.themeKeys ?? [], hasDefaultValue: p2.defaultValue !== void 0 && p2.defaultValue !== null, supportsFractions: p2.supportsFractions }]);
  }
  function s2(o, p2) {
    t.functional(o, (h2) => {
      if (!h2.value) return;
      let A2 = null;
      if (h2.value.kind === "arbitrary" ? (A2 = h2.value.value, A2 = X2(A2, h2.modifier, r)) : A2 = te2(h2, r, p2.themeKeys), A2 !== null) return p2.handle(A2);
  ...
  function a(o, p2, h2, { supportsNegative: A2 = false, supportsFractions: y2 = false } = {}) {
    A2 && t.static(`-${o}-px`, () => h2("-1px")), t.static(`${o}-px`, () => h2("1px")), n(o, { themeKeys: p2, supportsFractions: y2, supportsNegative: A2, defaultValue: null, handleBareValue: ({ value: C2 }) => {
      ...
      return !O2 || !ue(C2) ? null : `calc(${O2} * ${C2})`;
  ...
  for (let [o, p2, h2] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) a(o, p2, (A2) => [l3(h2, A2)], { supportsFractions: true });
  t.static("container", () => {
    let o = [...r.namespace("--breakpoint").values()];
    o.sort((h2, A2) => we(h2, A2, "asc"));
    let p2 = [l3("--tw-sort", "--tw-container-component"), l3("width", "100%")];
    for (let h2 of o) p2.push(z2("@media", `(width >= ${h2})`, [l3("max-width", h2)]));
    return p2;
    ...
    if (o.value) {
      ...
      if (o.value.fraction) {
        let [p2, h2] = g(o.value.fraction, "/");
        return !p(p2) || !p(h2) ? void 0 : [l3("flex", `calc(${o.value.fraction} * 100%)`)];
      }
  ...
  let c = () => L2([$2("--tw-border-spacing-x", "0", "<length>"), $2("--tw-border-spacing-y", "0", "<length>")]);
  ...
  let u2 = () => L2([$2("--tw-translate-x", "0"), $2("--tw-translate-y", "0"), $2("--tw-translate-z", "0")]);
  ...
  for (let o of ["x", "y"]) e(`-translate-${o}-full`, [u2, [`--tw-translate-${o}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${o}-full`, [u2, [`--tw-translate-${o}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), a(`translate-${o}`, ["--translate", "--spacing"], (p2) => [u2(), l3(`--tw-translate-${o}`, p2), l3("translate", "var(--tw-translate-x) var(--tw-translate-y)")], { supportsNegative: true, supportsFractions: true });
  ...
  let f2 = () => L2([$2("--tw-scale-x", "1"), $2("--tw-scale-y", "1"), $2("--tw-scale-z", "1")]);
  e("scale-none", [["scale", "none"]]);
  function g2({ negative: o }) {
    return (p2) => {
      if (!p2.value || p2.modifier) return;
      let h2;
      return p2.value.kind === "arbitrary" ? (h2 = p2.value.value, h2 = o ? `calc(${h2} * -1)` : h2, [l3("scale", h2)]) : (h2 = r.resolve(p2.value.value, ["--scale"]), !h2 && p(p2.value.value) && (h2 = `${p2.value.value}%`), h2 ? (h2 = o ? `calc(${h2} * -1)` : h2, [f2(), l3("--tw-scale-x", h2), l3("--tw-scale-y", h2), l3("--tw-scale-z", h2), l3("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0);
    };
  }
  ...
  for (let o of ["x", "y", "z"]) n(`scale-${o}`, { supportsNegative: true, themeKeys: ["--scale"], handleBareValue: ({ value: p2 }) => p(p2) ? `${p2}%` : null, handle: (p2) => [f2(), l3(`--tw-scale-${o}`, p2), l3("scale", `var(--tw-scale-x) var(--tw-scale-y)${o === "z" ? " var(--tw-scale-z)" : ""}`)] }), i(`scale-${o}`, () => [{ supportsNegative: true, values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--scale"] }]);
  ...
  function d2({ negative: o }) {
    return (p2) => {
      ...
      if (p2.value.kind === "arbitrary") {
        h2 = p2.value.value;
        let A2 = p2.value.dataType ?? pe(h2, ["angle", "vector"]);
        if (A2 === "vector") return [l3("rotate", `${h2} var(--tw-rotate)`)];
        if (A2 !== "angle") return [l3("rotate", o ? `calc(${h2} * -1)` : h2)];
      } else if (h2 = r.resolve(p2.value.value, ["--rotate"]), !h2 && p(p2.value.value) && (h2 = `${p2.value.value}deg`), !h2) return;
  ...
  {
    let o = ["var(--tw-rotate-x,)", "var(--tw-rotate-y,)", "var(--tw-rotate-z,)", "var(--tw-skew-x,)", "var(--tw-skew-y,)"].join(" "), p2 = () => L2([$2("--tw-rotate-x"), $2("--tw-rotate-y"), $2("--tw-rotate-z"), $2("--tw-skew-x"), $2("--tw-skew-y")]);
    for (let h2 of ["x", "y", "z"]) n(`rotate-${h2}`, { supportsNegative: true, themeKeys: ["--rotate"], handleBareValue: ({ value: A2 }) => p(A2) ? `${A2}deg` : null, handle: (A2) => [p2(), l3(`--tw-rotate-${h2}`, `rotate${h2.toUpperCase()}(${A2})`), l3("transform", o)] }), i(`rotate-${h2}`, () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
    n("skew", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}deg` : null, handle: (h2) => [p2(), l3("--tw-skew-x", `skewX(${h2})`), l3("--tw-skew-y", `skewY(${h2})`), l3("transform", o)] }), n("skew-x", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}deg` : null, handle: (h2) => [p2(), l3("--tw-skew-x", `skewX(${h2})`), l3("transform", o)] }), n("skew-y", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}deg` : null, handle: (h2) => [p2(), l3("--tw-skew-y", `skewY(${h2})`), l3("transform", o)] }), i("skew", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-x", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-y", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), t.functional("transform", (h2) => {
      if (h2.modifier) return;
      let A2 = null;
      if (h2.value ? h2.value.kind === "arbitrary" && (A2 = h2.value.value) : A2 = o, A2 !== null) return [p2(), l3("transform", A2)];
  ...
  let m = () => L2([$2("--tw-pan-x"), $2("--tw-pan-y"), $2("--tw-pinch-zoom")]);
  ...
  let w2 = () => L2([$2("--tw-scroll-snap-strictness", "proximity", "*")]);
      ...
      t.functional(h2, (y2) => {
        ...
        if (y2.value.kind === "arbitrary") {
          ...
          switch (y2.value.dataType ?? pe(C2, ["color", "line-width", "length"])) {
            ...
            default:
              return C2 = X2(C2, y2.modifier, r), C2 === null ? void 0 : A2.color(C2);
          }
        }
        {
  ...
  } }), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
  {
    let h2 = function(C2) {
      ...
      return (O2) => {
        ...
        if (O2.value.kind === "arbitrary") {
          ...
          switch (O2.value.dataType ?? pe(j2, ["angle"])) {
            case "angle":
              return j2 = C2 ? `calc(${j2} * -1)` : `${j2}`, [l3("--tw-gradient-position", j2), l3("background-image", `linear-gradient(var(--tw-gradient-stops,${j2}))`)];
            default:
              return C2 ? void 0 : [l3("--tw-gradient-position", j2), l3("background-image", `linear-gradient(var(--tw-gradient-stops,${j2}))`)];
          }
        }
        let V2 = O2.value.value;
        if (!C2 && p2.has(V2)) V2 = p2.get(V2);
      ...
      return (O2) => {
        ...
        if (((_a2 = O2.value) == null ? void 0 : _a2.kind) === "arbitrary") {
          if (O2.modifier) return;
          let j2 = O2.value.value;
          return [l3("--tw-gradient-position", j2), l3("background-image", `conic-gradient(var(--tw-gradient-stops,${j2}))`)];
        }
        let V2 = h2(O2.modifier);
        if (!O2.value) return [l3("--tw-gradient-position", V2), l3("background-image", "conic-gradient(var(--tw-gradient-stops))")];
    ...
    var G2 = h2, I2 = A2, W2 = y2;
    let o = ["oklab", "oklch", "srgb", "hsl", "longer", "shorter", "increasing", "decreasing"], p2 = /* @__PURE__ */ new Map([["to-t", "to top"], ["to-tr", "to top right"], ["to-r", "to right"], ["to-br", "to bottom right"], ["to-b", "to bottom"], ["to-bl", "to bottom left"], ["to-l", "to left"], ["to-tl", "to top left"]]);
    t.functional("-bg-linear", A2({ negative: true })), t.functional("bg-linear", A2({ negative: false })), i("bg-linear", () => [{ values: [...p2.keys()], modifiers: o }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: o }]), t.functional("-bg-conic", y2({ negative: true })), t.functional("bg-conic", y2({ negative: false })), i("bg-conic", () => [{ hasDefaultValue: true, modifiers: o }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: o }]), t.functional("bg-radial", (C2) => {
      if (!C2.value) {
        let O2 = h2(C2.modifier);
        return [l3("--tw-gradient-position", O2), l3("background-image", "radial-gradient(var(--tw-gradient-stops))")];
      }
      if (C2.value.kind === "arbitrary") {
        if (C2.modifier) return;
        let O2 = C2.value.value;
        return [l3("--tw-gradient-position", O2), l3("background-image", `radial-gradient(var(--tw-gradient-stops,${O2}))`)];
      }
  ...
  t.functional("bg", (o) => {
    if (o.value) {
      if (o.value.kind === "arbitrary") {
        ...
        switch (o.value.dataType ?? pe(p2, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
          case "percentage":
          case "position":
            return o.modifier ? void 0 : [l3("background-position", p2)];
          case "bg-size":
          case "length":
          case "size":
            return o.modifier ? void 0 : [l3("background-size", p2)];
          case "image":
          case "url":
            return o.modifier ? void 0 : [l3("background-image", p2)];
          default:
            return p2 = X2(p2, o.modifier, r), p2 === null ? void 0 : [l3("background-color", p2)];
        }
      }
      {
        let p2 = te2(o, r, ["--background-color", "--color"]);
        if (p2) return [l3("background-color", p2)];
      }
      {
        if (o.modifier) return;
        let p2 = r.resolve(o.value.value, ["--background-image"]);
        if (p2) return [l3("background-image", p2)];
      }
    }
      ...
      if (h2.value) {
        if (h2.value.kind === "arbitrary") {
          ...
          switch (h2.value.dataType ?? pe(A2, ["color", "length", "percentage"])) {
            case "length":
            case "percentage":
              return h2.modifier ? void 0 : p2.position(A2);
            default:
              return A2 = X2(A2, h2.modifier, r), A2 === null ? void 0 : p2.color(A2);
          }
        }
        {
          let A2 = te2(h2, r, ["--background-color", "--color"]);
          if (A2) return p2.color(A2);
        }
        {
          if (h2.modifier) return;
          let A2 = r.resolve(h2.value.value, ["--gradient-color-stop-positions"]);
          if (A2) return p2.position(A2);
          if (h2.value.value[h2.value.value.length - 1] === "%" && p(h2.value.value.slice(0, -1))) return p2.position(h2.value.value);
        }
      }
  ...
  x("from", { color: (o) => [v2(), l3("--tw-sort", "--tw-gradient-from"), l3("--tw-gradient-from", o), l3("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (o) => [v2(), l3("--tw-gradient-from-position", o)] }), e("via-none", [["--tw-gradient-via-stops", "initial"]]), x("via", { color: (o) => [v2(), l3("--tw-sort", "--tw-gradient-via"), l3("--tw-gradient-via", o), l3("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), l3("--tw-gradient-stops", "var(--tw-gradient-via-stops)")], position: (o) => [v2(), l3("--tw-gradient-via-position", o)] }), x("to", { color: (o) => [v2(), l3("--tw-sort", "--tw-gradient-to"), l3("--tw-gradient-to", o), l3("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (o) => [v2(), l3("--tw-gradient-to-position", o)] }), e("mask-none", [["mask-image", "none"]]), t.functional("mask", (o) => {
    ...
    let p2 = o.value.value;
    switch (o.value.dataType ?? pe(p2, ["image", "percentage", "position", "bg-size", "length", "url"])) {
      case "percentage":
      case "position":
        return o.modifier ? void 0 : [l3("mask-position", p2)];
      case "bg-size":
      case "length":
      case "size":
        return [l3("mask-size", p2)];
      case "image":
      case "url":
      default:
        return [l3("mask-image", p2)];
    }
  ...
  let k2 = () => L2([$2("--tw-mask-linear", "linear-gradient(#fff, #fff)"), $2("--tw-mask-radial", "linear-gradient(#fff, #fff)"), $2("--tw-mask-conic", "linear-gradient(#fff, #fff)")]);
  function N2(o, p2) {
    t.functional(o, (h2) => {
      if (h2.value) {
        if (h2.value.kind === "arbitrary") {
          ...
          switch (h2.value.dataType ?? pe(A2, ["length", "percentage", "color"])) {
            case "color":
              return A2 = X2(A2, h2.modifier, r), A2 === null ? void 0 : p2.color(A2);
            case "percentage":
              return h2.modifier || !p(A2.slice(0, -1)) ? void 0 : p2.position(A2);
            default:
              return h2.modifier ? void 0 : p2.position(A2);
          }
        }
        ...
        }
        {
          ...
          switch (A2) {
            case "number": {
              ...
              return !y2 || !ue(h2.value.value) ? void 0 : p2.position(`calc(${y2} * ${h2.value.value})`);
            }
            case "percentage":
              return p(h2.value.value.slice(0, -1)) ? p2.position(h2.value.value) : void 0;
            default:
              return;
          }
        }
  ...
  let b2 = () => L2([$2("--tw-mask-left", "linear-gradient(#fff, #fff)"), $2("--tw-mask-right", "linear-gradient(#fff, #fff)"), $2("--tw-mask-bottom", "linear-gradient(#fff, #fff)"), $2("--tw-mask-top", "linear-gradient(#fff, #fff)")]);
  function S(o, p2, h2) {
    N2(o, { color(A2) {
      ...
      for (let C2 of ["top", "right", "bottom", "left"]) h2[C2] && (y2.push(l3(`--tw-mask-${C2}`, `linear-gradient(to ${C2}, var(--tw-mask-${C2}-from-color) var(--tw-mask-${C2}-from-position), var(--tw-mask-${C2}-to-color) var(--tw-mask-${C2}-to-position))`)), y2.push(L2([$2(`--tw-mask-${C2}-from-position`, "0%"), $2(`--tw-mask-${C2}-to-position`, "100%"), $2(`--tw-mask-${C2}-from-color`, "black"), $2(`--tw-mask-${C2}-to-color`, "transparent")])), y2.push(l3(`--tw-mask-${C2}-${p2}-color`, A2)));
      return y2;
    }, position(A2) {
      let y2 = [k2(), b2(), l3("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), l3("mask-composite", "intersect"), l3("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
      for (let C2 of ["top", "right", "bottom", "left"]) h2[C2] && (y2.push(l3(`--tw-mask-${C2}`, `linear-gradient(to ${C2}, var(--tw-mask-${C2}-from-color) var(--tw-mask-${C2}-from-position), var(--tw-mask-${C2}-to-color) var(--tw-mask-${C2}-to-position))`)), y2.push(L2([$2(`--tw-mask-${C2}-from-position`, "0%"), $2(`--tw-mask-${C2}-to-position`, "100%"), $2(`--tw-mask-${C2}-from-color`, "black"), $2(`--tw-mask-${C2}-to-color`, "transparent")])), y2.push(l3(`--tw-mask-${C2}-${p2}-position`, A2)));
      return y2;
    } });
  }
  ...
  let P2 = () => L2([$2("--tw-mask-linear-position", "0deg"), $2("--tw-mask-linear-from-position", "0%"), $2("--tw-mask-linear-to-position", "100%"), $2("--tw-mask-linear-from-color", "black"), $2("--tw-mask-linear-to-color", "transparent")]);
  ...
  e("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]), e("mix-blend-plus-lighter", [["mix-blend-mode", "plus-lighter"]]), e("fill-none", [["fill", "none"]]), t.functional("fill", (o) => {
    ...
    let p2 = te2(o, r, ["--fill", "--color"]);
    if (p2) return [l3("fill", p2)];
    ...
    if (o.value) {
      if (o.value.kind === "arbitrary") {
        let p2 = o.value.value;
        switch (o.value.dataType ?? pe(p2, ["color", "number", "length", "percentage"])) {
          case "number":
          case "length":
          case "percentage":
            return o.modifier ? void 0 : [l3("stroke-width", p2)];
          default:
            return p2 = X2(o.value.value, o.modifier, r), p2 === null ? void 0 : [l3("stroke", p2)];
        }
      }
      {
        let p2 = te2(o, r, ["--stroke", "--color"]);
        if (p2) return [l3("stroke", p2)];
      }
      {
        let p2 = r.resolve(o.value.value, ["--stroke-width"]);
        if (p2) return [l3("stroke-width", p2)];
        if (p(o.value.value)) return [l3("stroke-width", o.value.value)];
      }
    }
  }), i("stroke", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--stroke", "--color"], modifiers: Array.from({ length: 21 }, (o, p2) => `${p2 * 5}`) }, { values: ["0", "1", "2", "3"], valueThemeKeys: ["--stroke-width"] }]), e("object-contain", [["object-fit", "contain"]]), e("object-cover", [["object-fit", "cover"]]), e("object-fill", [["object-fit", "fill"]]), e("object-none", [["object-fit", "none"]]), e("object-scale-down", [["object-fit", "scale-down"]]), e("object-top", [["object-position", "top"]]), e("object-top-left", [["object-position", "left top"]]), e("object-top-right", [["object-position", "right top"]]), e("object-bottom", [["object-position", "bottom"]]), e("object-bottom-left", [["object-position", "left bottom"]]), e("object-bottom-right", [["object-position", "right bottom"]]), e("object-left", [["object-position", "left"]]), e("object-right", [["object-position", "right"]]), e("object-center", [["object-position", "center"]]), n("object", { themeKeys: ["--object-position"], handle: (o) => [l3("object-position", o)] });
  for (let [o, p2] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) a(o, ["--padding", "--spacing"], (h2) => [l3(p2, h2)]);
  e("text-left", [["text-align", "left"]]), e("text-center", [["text-align", "center"]]), e("text-right", [["text-align", "right"]]), e("text-justify", [["text-align", "justify"]]), e("text-start", [["text-align", "start"]]), e("text-end", [["text-align", "end"]]), a("indent", ["--text-indent", "--spacing"], (o) => [l3("text-indent", o)], { supportsNegative: true }), e("align-baseline", [["vertical-align", "baseline"]]), e("align-top", [["vertical-align", "top"]]), e("align-middle", [["vertical-align", "middle"]]), e("align-bottom", [["vertical-align", "bottom"]]), e("align-text-top", [["vertical-align", "text-top"]]), e("align-text-bottom", [["vertical-align", "text-bottom"]]), e("align-sub", [["vertical-align", "sub"]]), e("align-super", [["vertical-align", "super"]]), n("align", { themeKeys: [], handle: (o) => [l3("vertical-align", o)] }), t.functional("font", (o) => {
    if (!(!o.value || o.modifier)) {
      if (o.value.kind === "arbitrary") {
        let p2 = o.value.value;
        switch (o.value.dataType ?? pe(p2, ["number", "generic-name", "family-name"])) {
          case "generic-name":
          case "family-name":
            return [l3("font-family", p2)];
          default:
            return [L2([$2("--tw-font-weight")]), l3("--tw-font-weight", p2), l3("font-weight", p2)];
        }
      }
      {
      ...
      }
      {
        ...
        if (p2) return [L2([$2("--tw-font-weight")]), l3("--tw-font-weight", p2), l3("font-weight", p2)];
      }
    }
    ...
    let p2 = Number(o.slice(0, -1));
    return !p(p2) || Number.isNaN(p2) || p2 < 50 || p2 > 200 ? null : o;
    ...
    if (o.value) {
      if (o.value.kind === "arbitrary") {
        let p2 = o.value.value;
        switch (o.value.dataType ?? pe(p2, ["color", "length", "percentage"])) {
          case "length":
          case "percentage":
            return o.modifier ? void 0 : [l3("text-decoration-thickness", p2)];
          default:
            return p2 = X2(p2, o.modifier, r), p2 === null ? void 0 : [l3("text-decoration-color", p2)];
        }
      }
      {
        let p2 = r.resolve(o.value.value, ["--text-decoration-thickness"]);
        if (p2) return o.modifier ? void 0 : [l3("text-decoration-thickness", p2)];
        if (p(o.value.value)) return o.modifier ? void 0 : [l3("text-decoration-thickness", `${o.value.value}px`)];
      }
      {
        let p2 = te2(o, r, ["--text-decoration-color", "--color"]);
        if (p2) return [l3("text-decoration-color", p2)];
      }
    }
  }), i("decoration", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-decoration-color", "--color"], modifiers: Array.from({ length: 21 }, (o, p2) => `${p2 * 5}`) }, { values: ["0", "1", "2"], valueThemeKeys: ["--text-decoration-thickness"] }]), e("animate-none", [["animation", "none"]]), n("animate", { themeKeys: ["--animate"], handle: (o) => [l3("animation", o)] });
  {
    let o = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" "), p2 = ["var(--tw-backdrop-blur,)", "var(--tw-backdrop-brightness,)", "var(--tw-backdrop-contrast,)", "var(--tw-backdrop-grayscale,)", "var(--tw-backdrop-hue-rotate,)", "var(--tw-backdrop-invert,)", "var(--tw-backdrop-opacity,)", "var(--tw-backdrop-saturate,)", "var(--tw-backdrop-sepia,)"].join(" "), h2 = () => L2([$2("--tw-blur"), $2("--tw-brightness"), $2("--tw-contrast"), $2("--tw-grayscale"), $2("--tw-hue-rotate"), $2("--tw-invert"), $2("--tw-opacity"), $2("--tw-saturate"), $2("--tw-sepia"), $2("--tw-drop-shadow"), $2("--tw-drop-shadow-color"), $2("--tw-drop-shadow-alpha", "100%", "<percentage>"), $2("--tw-drop-shadow-size")]), A2 = () => L2([$2("--tw-backdrop-blur"), $2("--tw-backdrop-brightness"), $2("--tw-backdrop-contrast"), $2("--tw-backdrop-grayscale"), $2("--tw-backdrop-hue-rotate"), $2("--tw-backdrop-invert"), $2("--tw-backdrop-opacity"), $2("--tw-backdrop-saturate"), $2("--tw-backdrop-sepia")]);
    t.functional("filter", (y2) => {
      ...
      if (!y2.modifier) {
        if (y2.value === null) return [A2(), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)];
    ...
    }), n("blur", { themeKeys: ["--blur"], handle: (y2) => [h2(), l3("--tw-blur", `blur(${y2})`), l3("filter", o)] }), e("blur-none", [h2, ["--tw-blur", " "], ["filter", o]]), n("backdrop-blur", { themeKeys: ["--backdrop-blur", "--blur"], handle: (y2) => [A2(), l3("--tw-backdrop-blur", `blur(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), e("backdrop-blur-none", [A2, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", p2], ["backdrop-filter", p2]]), n("brightness", { themeKeys: ["--brightness"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [h2(), l3("--tw-brightness", `brightness(${y2})`), l3("filter", o)] }), n("backdrop-brightness", { themeKeys: ["--backdrop-brightness", "--brightness"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [A2(), l3("--tw-backdrop-brightness", `brightness(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--brightness"] }]), i("backdrop-brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--backdrop-brightness", "--brightness"] }]), n("contrast", { themeKeys: ["--contrast"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [h2(), l3("--tw-contrast", `contrast(${y2})`), l3("filter", o)] }), n("backdrop-contrast", { themeKeys: ["--backdrop-contrast", "--contrast"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [A2(), l3("--tw-backdrop-contrast", `contrast(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--contrast"] }]), i("backdrop-contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--backdrop-contrast", "--contrast"] }]), n("grayscale", { themeKeys: ["--grayscale"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [h2(), l3("--tw-grayscale", `grayscale(${y2})`), l3("filter", o)] }), n("backdrop-grayscale", { themeKeys: ["--backdrop-grayscale", "--grayscale"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [A2(), l3("--tw-backdrop-grayscale", `grayscale(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--grayscale"], hasDefaultValue: true }]), i("backdrop-grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-grayscale", "--grayscale"], hasDefaultValue: true }]), n("hue-rotate", { supportsNegative: true, themeKeys: ["--hue-rotate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}deg` : null, handle: (y2) => [h2(), l3("--tw-hue-rotate", `hue-rotate(${y2})`), l3("filter", o)] }), n("backdrop-hue-rotate", { supportsNegative: true, themeKeys: ["--backdrop-hue-rotate", "--hue-rotate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}deg` : null, handle: (y2) => [A2(), l3("--tw-backdrop-hue-rotate", `hue-rotate(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--hue-rotate"] }]), i("backdrop-hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--backdrop-hue-rotate", "--hue-rotate"] }]), n("invert", { themeKeys: ["--invert"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [h2(), l3("--tw-invert", `invert(${y2})`), l3("filter", o)] }), n("backdrop-invert", { themeKeys: ["--backdrop-invert", "--invert"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [A2(), l3("--tw-backdrop-invert", `invert(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--invert"], hasDefaultValue: true }]), i("backdrop-invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-invert", "--invert"], hasDefaultValue: true }]), n("saturate", { themeKeys: ["--saturate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [h2(), l3("--tw-saturate", `saturate(${y2})`), l3("filter", o)] }), n("backdrop-saturate", { themeKeys: ["--backdrop-saturate", "--saturate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [A2(), l3("--tw-backdrop-saturate", `saturate(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--saturate"] }]), i("backdrop-saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--backdrop-saturate", "--saturate"] }]), n("sepia", { themeKeys: ["--sepia"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [h2(), l3("--tw-sepia", `sepia(${y2})`), l3("filter", o)] }), n("backdrop-sepia", { themeKeys: ["--backdrop-sepia", "--sepia"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [A2(), l3("--tw-backdrop-sepia", `sepia(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--sepia"], hasDefaultValue: true }]), i("backdrop-sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--backdrop-sepia", "--sepia"], hasDefaultValue: true }]), e("drop-shadow-none", [h2, ["--tw-drop-shadow", " "], ["filter", o]]), t.functional("drop-shadow", (y2) => {
      let C2;
      if (y2.modifier && (y2.modifier.kind === "arbitrary" ? C2 = y2.modifier.value : p(y2.modifier.value) && (C2 = `${y2.modifier.value}%`)), !y2.value) {
        ...
        return O2 === null || V2 === null ? void 0 : [h2(), l3("--tw-drop-shadow-alpha", C2), ...Ye("--tw-drop-shadow-size", O2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), l3("--tw-drop-shadow", g(V2, ",").map((T2) => `drop-shadow(${T2})`).join(" ")), l3("filter", o)];
      }
      if (y2.value.kind === "arbitrary") {
        let O2 = y2.value.value;
        switch (y2.value.dataType ?? pe(O2, ["color"])) {
          case "color":
            return O2 = X2(O2, y2.modifier, r), O2 === null ? void 0 : [h2(), l3("--tw-drop-shadow-color", Q2(O2, "var(--tw-drop-shadow-alpha)")), l3("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
          default:
            return y2.modifier && !C2 ? void 0 : [h2(), l3("--tw-drop-shadow-alpha", C2), ...Ye("--tw-drop-shadow-size", O2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), l3("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), l3("filter", o)];
        }
      }
      {
        let O2 = r.get([`--drop-shadow-${y2.value.value}`]), V2 = r.resolve(y2.value.value, ["--drop-shadow"]);
        if (O2 && V2) return y2.modifier && !C2 ? void 0 : C2 ? [h2(), l3("--tw-drop-shadow-alpha", C2), ...Ye("--tw-drop-shadow-size", O2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), l3("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), l3("filter", o)] : [h2(), l3("--tw-drop-shadow-alpha", C2), ...Ye("--tw-drop-shadow-size", O2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), l3("--tw-drop-shadow", g(V2, ",").map((T2) => `drop-shadow(${T2})`).join(" ")), l3("filter", o)];
      }
      {
        let O2 = te2(y2, r, ["--drop-shadow-color", "--color"]);
        if (O2) return O2 === "inherit" ? [h2(), l3("--tw-drop-shadow-color", "inherit"), l3("--tw-drop-shadow", "var(--tw-drop-shadow-size)")] : [h2(), l3("--tw-drop-shadow-color", Q2(O2, "var(--tw-drop-shadow-alpha)")), l3("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
      }
    }), i("drop-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--drop-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (y2, C2) => `${C2 * 5}`) }, { valueThemeKeys: ["--drop-shadow"] }]), n("backdrop-opacity", { themeKeys: ["--backdrop-opacity", "--opacity"], handleBareValue: ({ value: y2 }) => de(y2) ? `${y2}%` : null, handle: (y2) => [A2(), l3("--tw-backdrop-opacity", `opacity(${y2})`), l3("-webkit-backdrop-filter", p2), l3("backdrop-filter", p2)] }), i("backdrop-opacity", () => [{ values: Array.from({ length: 21 }, (y2, C2) => `${C2 * 5}`), valueThemeKeys: ["--backdrop-opacity", "--opacity"] }]);
  }
  {
    let o = `var(--tw-ease, ${r.resolve(null, ["--default-transition-timing-function"]) ?? "ease"})`, p2 = `var(--tw-duration, ${r.resolve(null, ["--default-transition-duration"]) ?? "0s"})`;
    e("transition-none", [["transition-property", "none"]]), e("transition-all", [["transition-property", "all"], ["transition-timing-function", o], ["transition-duration", p2]]), e("transition-colors", [["transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"], ["transition-timing-function", o], ["transition-duration", p2]]), e("transition-opacity", [["transition-property", "opacity"], ["transition-timing-function", o], ["transition-duration", p2]]), e("transition-shadow", [["transition-property", "box-shadow"], ["transition-timing-function", o], ["transition-duration", p2]]), e("transition-transform", [["transition-property", "transform, translate, scale, rotate"], ["transition-timing-function", o], ["transition-duration", p2]]), n("transition", { defaultValue: "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to, opacity, box-shadow, transform, translate, scale, rotate, filter, -webkit-backdrop-filter, backdrop-filter, display, visibility, content-visibility, overlay, pointer-events", themeKeys: ["--transition-property"], handle: (h2) => [l3("transition-property", h2), l3("transition-timing-function", o), l3("transition-duration", p2)] }), e("transition-discrete", [["transition-behavior", "allow-discrete"]]), e("transition-normal", [["transition-behavior", "normal"]]), n("delay", { handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}ms` : null, themeKeys: ["--transition-delay"], handle: (h2) => [l3("transition-delay", h2)] });
    {
      let h2 = () => L2([$2("--tw-duration")]);
  ...
  {
    let o = () => L2([$2("--tw-ease")]);
    e("ease-initial", [o, ["--tw-ease", "initial"]]), e("ease-linear", [o, ["--tw-ease", "linear"], ["transition-timing-function", "linear"]]), n("ease", { themeKeys: ["--ease"], handle: (p2) => [o(), l3("--tw-ease", p2), l3("transition-timing-function", p2)] });
  }
  e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), n("will-change", { themeKeys: [], handle: (o) => [l3("will-change", o)] }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), n("content", { themeKeys: [], handle: (o) => [L2([$2("--tw-content", '""')]), l3("--tw-content", o), l3("content", "var(--tw-content)")] });
  {
    let o = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", p2 = () => L2([$2("--tw-contain-size"), $2("--tw-contain-layout"), $2("--tw-contain-paint"), $2("--tw-contain-style")]);
    e("contain-none", [["contain", "none"]]), e("contain-content", [["contain", "content"]]), e("contain-strict", [["contain", "strict"]]), e("contain-size", [p2, ["--tw-contain-size", "size"], ["contain", o]]), e("contain-inline-size", [p2, ["--tw-contain-size", "inline-size"], ["contain", o]]), e("contain-layout", [p2, ["--tw-contain-layout", "layout"], ["contain", o]]), e("contain-paint", [p2, ["--tw-contain-paint", "paint"], ["contain", o]]), e("contain-style", [p2, ["--tw-contain-style", "style"], ["contain", o]]), n("contain", { themeKeys: [], handle: (h2) => [l3("contain", h2)] });
  }
  e("forced-color-adjust-none", [["forced-color-adjust", "none"]]), e("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), e("leading-none", [() => L2([$2("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), a("leading", ["--leading", "--spacing"], (o) => [L2([$2("--tw-leading")]), l3("--tw-leading", o), l3("line-height", o)]), n("tracking", { supportsNegative: true, themeKeys: ["--tracking"], handle: (o) => [L2([$2("--tw-tracking")]), l3("--tw-tracking", o), l3("letter-spacing", o)] }), e("antialiased", [["-webkit-font-smoothing", "antialiased"], ["-moz-osx-font-smoothing", "grayscale"]]), e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
  {
    let o = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", p2 = () => L2([$2("--tw-ordinal"), $2("--tw-slashed-zero"), $2("--tw-numeric-figure"), $2("--tw-numeric-spacing"), $2("--tw-numeric-fraction")]);
  ...
  {
    let o = () => L2([$2("--tw-outline-style", "solid")]);
    t.static("outline-hidden", () => [l3("--tw-outline-style", "none"), l3("outline-style", "none"), z2("@media", "(forced-colors: active)", [l3("outline", "2px solid transparent"), l3("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), t.functional("outline", (p2) => {
      if (p2.value === null) {
      ...
      if (p2.value.kind === "arbitrary") {
        let h2 = p2.value.value;
        switch (p2.value.dataType ?? pe(h2, ["color", "length", "number", "percentage"])) {
          case "length":
          case "number":
          case "percentage":
            return p2.modifier ? void 0 : [o(), l3("outline-style", "var(--tw-outline-style)"), l3("outline-width", h2)];
          default:
            return h2 = X2(h2, p2.modifier, r), h2 === null ? void 0 : [l3("outline-color", h2)];
        }
      }
      {
        let h2 = te2(p2, r, ["--outline-color", "--color"]);
        if (h2) return [l3("outline-color", h2)];
      }
      {
        if (p2.modifier) return;
        let h2 = r.resolve(p2.value.value, ["--outline-width"]);
        if (h2) return [o(), l3("outline-style", "var(--tw-outline-style)"), l3("outline-width", h2)];
        if (p(p2.value.value)) return [o(), l3("outline-style", "var(--tw-outline-style)"), l3("outline-width", `${p2.value.value}px`)];
      }
    }), i("outline", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--outline-color", "--color"], modifiers: Array.from({ length: 21 }, (p2, h2) => `${h2 * 5}`), hasDefaultValue: true }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--outline-width"] }]), n("outline-offset", { supportsNegative: true, themeKeys: ["--outline-offset"], handleBareValue: ({ value: p2 }) => p(p2) ? `${p2}px` : null, handle: (p2) => [l3("outline-offset", p2)] }), i("outline-offset", () => [{ supportsNegative: true, values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--outline-offset"] }]);
  }
  n("opacity", { themeKeys: ["--opacity"], handleBareValue: ({ value: o }) => de(o) ? `${o}%` : null, handle: (o) => [l3("opacity", o)] }), i("opacity", () => [{ values: Array.from({ length: 21 }, (o, p2) => `${p2 * 5}`), valueThemeKeys: ["--opacity"] }]), e("underline-offset-auto", [["text-underline-offset", "auto"]]), n("underline-offset", { supportsNegative: true, themeKeys: ["--text-underline-offset"], handleBareValue: ({ value: o }) => p(o) ? `${o}px` : null, handle: (o) => [l3("text-underline-offset", o)] }), i("underline-offset", () => [{ supportsNegative: true, values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--text-underline-offset"] }]), t.functional("text", (o) => {
    if (o.value) {
      if (o.value.kind === "arbitrary") {
        let p2 = o.value.value;
        switch (o.value.dataType ?? pe(p2, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
          case "size":
          case "length":
          case "percentage":
          case "absolute-size":
          case "relative-size": {
            if (o.modifier) {
              ...
              return !A2 && o.modifier.value === "none" && (A2 = "1"), A2 ? [l3("font-size", p2), l3("line-height", A2)] : null;
            }
            return [l3("font-size", p2)];
          }
          default:
            return p2 = X2(p2, o.modifier, r), p2 === null ? void 0 : [l3("color", p2)];
        }
      }
      {
        let p2 = te2(o, r, ["--text-color", "--color"]);
        if (p2) return [l3("color", p2)];
      }
      {
  ...
  let _2 = () => L2([$2("--tw-text-shadow-color"), $2("--tw-text-shadow-alpha", "100%", "<percentage>")]);
  e("text-shadow-initial", [_2, ["--tw-text-shadow-color", "initial"]]), t.functional("text-shadow", (o) => {
    let p2;
    if (o.modifier && (o.modifier.kind === "arbitrary" ? p2 = o.modifier.value : p(o.modifier.value) && (p2 = `${o.modifier.value}%`)), !o.value) {
      let h2 = r.get(["--text-shadow"]);
      return h2 === null ? void 0 : [_2(), l3("--tw-text-shadow-alpha", p2), ...ue2("text-shadow", h2, p2, (A2) => `var(--tw-text-shadow-color, ${A2})`)];
    }
    if (o.value.kind === "arbitrary") {
      let h2 = o.value.value;
      switch (o.value.dataType ?? pe(h2, ["color"])) {
        case "color":
          return h2 = X2(h2, o.modifier, r), h2 === null ? void 0 : [_2(), l3("--tw-text-shadow-color", Q2(h2, "var(--tw-text-shadow-alpha)"))];
        default:
          return [_2(), l3("--tw-text-shadow-alpha", p2), ...ue2("text-shadow", h2, p2, (y2) => `var(--tw-text-shadow-color, ${y2})`)];
      }
    }
    switch (o.value.value) {
      case "none":
        return o.modifier ? void 0 : [_2(), l3("text-shadow", "none")];
      case "inherit":
        return o.modifier ? void 0 : [_2(), l3("--tw-text-shadow-color", "inherit")];
    }
    {
      let h2 = r.get([`--text-shadow-${o.value.value}`]);
      if (h2) return [_2(), l3("--tw-text-shadow-alpha", p2), ...ue2("text-shadow", h2, p2, (A2) => `var(--tw-text-shadow-color, ${A2})`)];
    }
    {
      let h2 = te2(o, r, ["--text-shadow-color", "--color"]);
      if (h2) return [_2(), l3("--tw-text-shadow-color", Q2(h2, "var(--tw-text-shadow-alpha)"))];
    }
  }), i("text-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (o, p2) => `${p2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--text-shadow"], modifiers: Array.from({ length: 21 }, (o, p2) => `${p2 * 5}`), hasDefaultValue: r.get(["--text-shadow"]) !== null }]);
  {
    ...
    var Z2 = y2, re2 = C2;
    let o = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", "), p2 = "0 0 #0000", h2 = () => L2([$2("--tw-shadow", p2), $2("--tw-shadow-color"), $2("--tw-shadow-alpha", "100%", "<percentage>"), $2("--tw-inset-shadow", p2), $2("--tw-inset-shadow-color"), $2("--tw-inset-shadow-alpha", "100%", "<percentage>"), $2("--tw-ring-color"), $2("--tw-ring-shadow", p2), $2("--tw-inset-ring-color"), $2("--tw-inset-ring-shadow", p2), $2("--tw-ring-inset"), $2("--tw-ring-offset-width", "0px", "<length>"), $2("--tw-ring-offset-color", "#fff"), $2("--tw-ring-offset-shadow", p2)]);
    e("shadow-initial", [h2, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (V2) => {
      ...
      if (V2.modifier && (V2.modifier.kind === "arbitrary" ? T2 = V2.modifier.value : p(V2.modifier.value) && (T2 = `${V2.modifier.value}%`)), !V2.value) {
        let j2 = r.get(["--shadow"]);
        return j2 === null ? void 0 : [h2(), l3("--tw-shadow-alpha", T2), ...ue2("--tw-shadow", j2, T2, (oe) => `var(--tw-shadow-color, ${oe})`), l3("box-shadow", o)];
      }
      if (V2.value.kind === "arbitrary") {
        let j2 = V2.value.value;
        switch (V2.value.dataType ?? pe(j2, ["color"])) {
          case "color":
            return j2 = X2(j2, V2.modifier, r), j2 === null ? void 0 : [h2(), l3("--tw-shadow-color", Q2(j2, "var(--tw-shadow-alpha)"))];
          default:
            return [h2(), l3("--tw-shadow-alpha", T2), ...ue2("--tw-shadow", j2, T2, (ot) => `var(--tw-shadow-color, ${ot})`), l3("box-shadow", o)];
        }
      }
      switch (V2.value.value) {
        case "none":
          return V2.modifier ? void 0 : [h2(), l3("--tw-shadow", p2), l3("box-shadow", o)];
        case "inherit":
          return V2.modifier ? void 0 : [h2(), l3("--tw-shadow-color", "inherit")];
      }
      {
        let j2 = r.get([`--shadow-${V2.value.value}`]);
        if (j2) return [h2(), l3("--tw-shadow-alpha", T2), ...ue2("--tw-shadow", j2, T2, (oe) => `var(--tw-shadow-color, ${oe})`), l3("box-shadow", o)];
      }
      {
        let j2 = te2(V2, r, ["--box-shadow-color", "--color"]);
        if (j2) return [h2(), l3("--tw-shadow-color", Q2(j2, "var(--tw-shadow-alpha)"))];
      }
      ...
      if (V2.modifier && (V2.modifier.kind === "arbitrary" ? T2 = V2.modifier.value : p(V2.modifier.value) && (T2 = `${V2.modifier.value}%`)), !V2.value) {
        ...
        return j2 === null ? void 0 : [h2(), l3("--tw-inset-shadow-alpha", T2), ...ue2("--tw-inset-shadow", j2, T2, (oe) => `var(--tw-inset-shadow-color, ${oe})`), l3("box-shadow", o)];
      }
      if (V2.value.kind === "arbitrary") {
        let j2 = V2.value.value;
        switch (V2.value.dataType ?? pe(j2, ["color"])) {
          case "color":
            return j2 = X2(j2, V2.modifier, r), j2 === null ? void 0 : [h2(), l3("--tw-inset-shadow-color", Q2(j2, "var(--tw-inset-shadow-alpha)"))];
          default:
            return [h2(), l3("--tw-inset-shadow-alpha", T2), ...ue2("--tw-inset-shadow", j2, T2, (ot) => `var(--tw-inset-shadow-color, ${ot})`, "inset "), l3("box-shadow", o)];
        }
      }
      switch (V2.value.value) {
        case "none":
          return V2.modifier ? void 0 : [h2(), l3("--tw-inset-shadow", p2), l3("box-shadow", o)];
        case "inherit":
          return V2.modifier ? void 0 : [h2(), l3("--tw-inset-shadow-color", "inherit")];
      }
      {
        let j2 = r.get([`--inset-shadow-${V2.value.value}`]);
        if (j2) return [h2(), l3("--tw-inset-shadow-alpha", T2), ...ue2("--tw-inset-shadow", j2, T2, (oe) => `var(--tw-inset-shadow-color, ${oe})`), l3("box-shadow", o)];
      }
      {
        let j2 = te2(V2, r, ["--box-shadow-color", "--color"]);
        if (j2) return [h2(), l3("--tw-inset-shadow-color", Q2(j2, "var(--tw-inset-shadow-alpha)"))];
      }
    ...
    t.functional("ring-offset", (V2) => {
      if (V2.value) {
        if (V2.value.kind === "arbitrary") {
          ...
          switch (V2.value.dataType ?? pe(T2, ["color", "length"])) {
            case "length":
              return V2.modifier ? void 0 : [l3("--tw-ring-offset-width", T2), l3("--tw-ring-offset-shadow", O2)];
            default:
        ...
        }
        {
          ...
          if (T2) return V2.modifier ? void 0 : [l3("--tw-ring-offset-width", T2), l3("--tw-ring-offset-shadow", O2)];
          if (p(V2.value.value)) return V2.modifier ? void 0 : [l3("--tw-ring-offset-width", `${V2.value.value}px`), l3("--tw-ring-offset-shadow", O2)];
        }
        {
  ...
  return i("ring-offset", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--ring-offset-color", "--color"], modifiers: Array.from({ length: 21 }, (o, p2) => `${p2 * 5}`) }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--ring-offset-width"] }]), t.functional("@container", (o) => {
    let p2 = null;
    if (o.value === null ? p2 = "inline-size" : o.value.kind === "arbitrary" ? p2 = o.value.value : o.value.kind === "named" && o.value.value === "normal" && (p2 = "normal"), p2 !== null) return o.modifier ? [l3("container-type", p2), l3("container-name", o.modifier.value)] : [l3("container-type", p2)];
...
`);
          let f2 = u2.value, g2 = structuredClone(a), d2 = "¶";
          ee2(g2.nodes, (x, { replaceWith: k2 }) => {
            x.kind === "word" && x.value === f2 && k2({ kind: "word", value: d2 });
          });
          let m = "^".repeat(Y2([u2]).length), w2 = Y2([g2]).indexOf(d2), v2 = ["```css", Y2([a]), " ".repeat(w2) + m, "```"].join(`
`);
          console.warn(v2);
        }
      }), n.value = Y2(s2);
      ...
      if (F2([s2], (v2, { parent: x, replaceWith: k2 }) => {
...
function or(r, t, i) {
  for (let e of t.nodes) {
    ...
    if (r.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
      ...
      return { nodes: q2(n), ratio: s2 === "ratio" };
      ...
      if (pe(r.value, [n]) !== null) return { nodes: q2(r.value) };
    }
  }
}
function ue2(r, t, i, e, n = "") {
  let s2 = false, a = Ee(t, (u2) => i == null ? e(u2) : u2.startsWith("current") ? e(Q2(u2, i)) : ((u2.startsWith("var(") || i.startsWith("var(")) && (s2 = true), e(lr(u2, i))));
  function c(u2) {
...
function Ye(r, t, i, e, n = "") {
  let s2 = false, a = g(t, ",").map((c) => Ee(c, (u2) => i == null ? e(u2) : u2.startsWith("current") ? e(Q2(u2, i)) : ((u2.startsWith("var(") || i.startsWith("var(")) && (s2 = true), e(lr(u2, i))))).map((c) => `drop-shadow(${c})`).join(" ");
...
var Pi = /^\d+\/\d+$/;
function pr(r) {
  let t = new B2((n) => ({ name: n, utility: n, fraction: false, modifiers: [] }));
...
function Ri(r) {
  let t = [], i = null, e = /* @__PURE__ */ new Map(), n = new B2(() => []);
  for (let a of r) {
...
function mr(r, t) {
  var _a2;
  let { astNodes: i, nodeSorting: e } = pe2(Array.from(t), r), n = new Map(t.map((a) => [a, null])), s2 = 0n;
  for (let a of i) {
...
function hr(r) {
  ...
  function s2(f2) {
    for (let g2 of n) {
      ...
      let d2 = g(f2.params, ",");
      return d2.length > 1 ? null : (d2 = e(f2.name, d2), z2(f2.name, d2.join(", ")));
    }
    return null;
  }
  function a(f2) {
  ...
  t.compound("not", 3, (f2, g2) => {
    ...
    if (F2([f2], (m, { path: w2 }) => {
      ...
      return Object.assign(f2, M2("&", k2)), d2 = true, 1;
    ...
    let d2 = g2.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group\\/${g2.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group)`, m = false;
    if (F2([f2], (w2, { path: v2 }) => {
    ...
    if (g2.variant.kind === "arbitrary" && g2.variant.relative) return null;
    let d2 = g2.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer\\/${g2.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer)`, m = false;
    if (F2([f2], (w2, { path: v2 }) => {
      if (w2.kind !== "rule") return 0;
      for (let k2 of v2.slice(0, -1)) if (k2.kind === "rule") return m = false, 2;
      let x = w2.selector.replaceAll("&", d2);
  ...
  {
    let f2 = function() {
      return L2([z2("@property", "--tw-content", [l3("syntax", '"*"'), l3("initial-value", '""'), l3("inherits", "false")])]);
    };
    var c = f2;
    t.static("before", (g2) => {
  ...
  i("first", ["&:first-child"]), i("last", ["&:last-child"]), i("only", ["&:only-child"]), i("odd", ["&:nth-child(odd)"]), i("even", ["&:nth-child(even)"]), i("first-of-type", ["&:first-of-type"]), i("last-of-type", ["&:last-of-type"]), i("only-of-type", ["&:only-of-type"]), i("visited", ["&:visited"]), i("target", ["&:target"]), i("open", ["&:is([open], :popover-open, :open)"]), i("default", ["&:default"]), i("checked", ["&:checked"]), i("indeterminate", ["&:indeterminate"]), i("placeholder-shown", ["&:placeholder-shown"]), i("autofill", ["&:autofill"]), i("optional", ["&:optional"]), i("required", ["&:required"]), i("valid", ["&:valid"]), i("invalid", ["&:invalid"]), i("user-valid", ["&:user-valid"]), i("user-invalid", ["&:user-invalid"]), i("in-range", ["&:in-range"]), i("out-of-range", ["&:out-of-range"]), i("read-only", ["&:read-only"]), i("empty", ["&:empty"]), i("focus-within", ["&:focus-within"]), t.static("hover", (f2) => {
    ...
    d2.includes(":") || (d2 = `${d2}: var(--tw)`), (d2[0] !== "(" || d2[d2.length - 1] !== ")") && (d2 = `(${d2})`), f2.nodes = [z2("@supports", d2, f2.nodes)];
  }, { compounds: 1 }), i("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), i("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), i("contrast-more", ["@media (prefers-contrast: more)"]), i("contrast-less", ["@media (prefers-contrast: less)"]);
  {
    ...
    var u2 = f2;
    {
      let g2 = r.namespace("--breakpoint"), d2 = new B2((m) => {
        switch (m.kind) {
          case "static":
    ...
    {
      let g2 = r.namespace("--container"), d2 = new B2((m) => {
        switch (m.kind) {
          case "functional": {
...
function At(r, t) {
  F2(r, (i, { replaceWith: e }) => {
    ...
    else if (i.kind === "at-rule" && (i.name === "@keyframes" || i.name === "@property")) return Object.assign(i, L2([z2(i.name, i.params, i.nodes)])), 1;
  });
}
function vr(r) {
  let t = sr(r), i = hr(r), e = new B2((u2) => er(u2, c)), n = new B2((u2) => Array.from(Xt(u2, c))), s2 = new B2((u2) => {
    let f2 = wr(u2, c);
    try {
    ...
    let f2 = [];
    for (let g2 of u2) {
      let d2 = false, { astNodes: m } = pe2([g2], this, { onInvalidCandidate() {
        d2 = true;
      } });
      m = ve(m, c, 0), m.length === 0 || d2 ? f2.push(null) : f2.push(ne2(m));
    }
    return f2;
  }, getClassOrder(u2) {
    return mr(this, u2);
...
function pe2(r, t, { onInvalidCandidate: i } = {}) {
...
function Oe(r, t) {
  let i = 0, e = H2("&", r), n = /* @__PURE__ */ new Set(), s2 = new B2(() => /* @__PURE__ */ new Set()), a = new B2(() => /* @__PURE__ */ new Set());
  F2([e], (d2, { parent: m, path: w2 }) => {
    if (d2.kind === "at-rule") {
      if (d2.name === "@keyframes") return F2(d2.nodes, (v2) => {
        if (v2.kind === "at-rule" && v2.name === "@apply") throw new Error("You cannot use `@apply` inside `@keyframes`.");
      }), 1;
      if (d2.name === "@utility") {
        let v2 = d2.params.replace(/-\*$/, "");
        a.get(v2).add(d2), F2(d2.nodes, (x) => {
  ...
  function g2(d2, m = []) {
    if (!c.has(d2)) {
      if (f2.has(d2)) {
        ...
        throw d2.kind === "at-rule" && d2.name === "@utility" && w2.kind === "at-rule" && w2.name === "@utility" && F2(d2.nodes, (v2) => {
...
${ne2([w2])}`);
      ...
      f2.add(d2);
      for (let w2 of s2.get(d2)) for (let v2 of a.get(w2)) m.push(d2), g2(v2, m), m.pop();
      c.add(d2), f2.delete(d2), u2.push(d2);
    }
  }
  for (let d2 of n) g2(d2);
  for (let d2 of u2) "nodes" in d2 && F2(d2.nodes, (m, { replaceWith: w2 }) => {
    ...
    {
      let N2 = Object.keys(x), b2 = pe2(N2, t, { onInvalidCandidate: (R2) => {
        ...
        if (R2 = structuredClone(R2), !S || !_2 || K2 === void 0) return F2([R2], (I2) => {
          I2.src = S;
        }), R2;
        let G2 = [S[0], S[1], S[2]];
        return G2[1] += 7 + K2, G2[2] = G2[1] + _2.length, F2([R2], (I2) => {
          I2.src = G2;
        }), R2;
      }), U2 = [];
...
async function $t(r, t, i, e = 0, n = false) {
  let s2 = 0, a = [];
  return F2(r, (c, { replaceWith: u2 }) => {
    if (c.kind === "at-rule" && (c.name === "@import" || c.name === "@reference")) {
      let f2 = _i(q2(c.params));
      if (f2 === null) return;
...
function rt(r, t, i) {
  return function(n, s2) {
    ...
    return c && typeof u2 == "string" && (u2 = Q2(u2, c)), u2 ?? s2;
  };
}
function Li(r, t) {
  if (t.length === 1 && t[0].startsWith("--")) return [r.get([t[0]]), r.getOptions(t[0])];
  let i = et(t), e = /* @__PURE__ */ new Map(), n = new B2(() => /* @__PURE__ */ new Map()), s2 = r.namespace(`--${i}`);
...
function Vt({ designSystem: r, ast: t, resolvedConfig: i, featuresRef: e, referenceMode: n }) {
  let s2 = { addBase(a) {
    ...
    c = c.flatMap(([f2, g2]) => g(f2, ",").map((d2) => [d2.trim(), g2]));
    let u2 = new B2(() => []);
    for (let [f2, g2] of c) {
      ...
      if (je(d2, (w2) => {
        if (w2.kind === "selector" && w2.value[0] === "." && Dr.test(w2.value.slice(1))) {
          let v2 = w2.value;
          w2.value = "&";
          let x = De(d2), k2 = v2.slice(1), N2 = x === "&" ? ae(g2) : [H2(x, ae(g2))];
    ...
    for (let [f2, g2] of u2) r.theme.prefix && F2(g2, (d2) => {
      if (d2.kind === "rule") {
    ...
    for (let [g2, d2] of Object.entries(a)) {
      let m = function({ negative: w2 }) {
        return (v2) => {
          ...
          x && b2 !== null && (k2 = Q2(k2, b2)), w2 && (k2 = `calc(${k2} * -1)`);
...
async function Jr({ designSystem: r, base: t, ast: i, loadModule: e, sources: n }) {
  let s2 = 0, a = [], c = [];
  F2(i, (d2, { parent: m, replaceWith: w2, context: v2 }) => {
    if (d2.kind === "at-rule") {
      if (d2.name === "@plugin") {
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
  ...
  let [f2, g2] = await Promise.all([Promise.all(c.map(async ({ id: d2, base: m, reference: w2 }) => {
...
function Gr({ designSystem: r, base: t, ast: i, sources: e, configs: n, pluginDetails: s2 }) {
  ...
  if (xr(r, g2, d2), Fr(r, g2, d2), qr(g2, r), Br(g2, r), zr(g2, r), !r.theme.prefix && f2.prefix) {
  ...
  if (!r.important && f2.important === true && (r.important = true), typeof f2.important == "string") {
    let k2 = f2.important;
    F2(i, (N2, { replaceWith: b2, parent: S }) => {
...
function Yr({ ast: r }) {
  let t = new B2((n) => Hr(n.code)), i = new B2((n) => ({ url: n.file, content: n.code, ignore: false })), e = { file: null, sources: [], mappings: [] };
  F2(r, (n) => {
...
function nt(r) {
  ...
  let g2 = nt(u2);
  for (let d2 of g2) for (let m of f2) i.push(e + m + d2);
  return i;
}
function an(r) {
  return Zr.test(r);
...
async function Qr(r, { base: t = "", from: i, loadModule: e = fn, loadStylesheet: n = cn } = {}) {
  ...
  let a = null, c = new Be(), u2 = [], f2 = [], g2 = null, d2 = null, m = [], w2 = [], v2 = [], x = [], k2 = null;
  F2(r, (b2, { parent: S, replaceWith: P2, context: U2 }) => {
    if (b2.kind === "at-rule") {
      ...
      if (b2.name === "@variant" && (S === null ? b2.nodes.length === 0 ? b2.name = "@custom-variant" : (F2(b2.nodes, (R2) => {
        ...
        if (b2.nodes.length === 0) {
          ...
          u2.push((W2) => {
            W2.variants.static(R2, (Z2) => {
              let re2 = [];
              I2.length > 0 && re2.push(M2(I2.join(", "), Z2.nodes));
      ...
      if (b2.name === "@theme") {
        ...
        return F2(b2.nodes, (K2) => {
          ...
          if (K2.kind === "declaration" && K2.property.startsWith("--")) {
            c.add(ge2(K2.property), K2.value ?? "", R2, K2.src);
            return;
          }
          let G2 = ne2([z2(b2.name, b2.params, [K2])]).split(`
...
${G2}`);
  ...
  if (g2) {
    ...
    for (let [P2, U2] of N2.theme.entries()) {
      ...
      let R2 = l3(fe(P2), U2.value);
      R2.src = U2.src, b2.push(R2);
    }
    let S = N2.theme.getKeyframes();
    for (let P2 of S) r.push(le({ theme: true }, [L2([P2])]));
    g2.nodes = [le({ theme: true }, b2)];
  }
  if (m.length > 0) {
    for (let b2 of m) {
      let S = M2("&", b2.nodes), P2 = b2.params, U2 = N2.parseVariant(P2);
...
async function dn(r, t = {}) {
  ...
  return { sources: n, root: s2, features: c, build(v2) {
    ...
    let b2 = pe2(g2, i, { onInvalidCandidate: f2 }).astNodes;
    return t.from && F2(b2, (S) => {
      S.src ?? (S.src = a.src);
...
export {
  Pe as Features,
  dt as Polyfills,
  Ca as __unstable__loadDesignSystem,
  Aa as compile,
  dn as compileAst,
  mn as default
};
